/*This section deals with the establishment of connection with the database in this case it may be either HIVE/MYSQL
 The initial part first establishes a successful connection with the database using JDBC and then each request is executed*/
...
public class ClimaAccessDao implements ClimaDao {
	...
	/*Creation of a successful connection with hive database*/
...
/*Describe the method for getting all the information regarding temperature */
	@Override
	...
	/*Describe the method for getting all the information regarding snow */
	@Override
	public Pojo getDetailsForSnow(String city, int day, int month, int year) {
		...
		try { 
			String query =  "select c.city, r.day,r.month,r.year,s.SNOWDEPTH,s.climacondition from city_name c,record r,snow s where r.day="+day+" and r.month="+month+" and r.year="+year+" and c.city='"+city.toUpperCase()+"' and c.city=r.city and r.day=s.day and r.month=s.month and r.year =s.year AND C.CITY=s.CITY";
			conn =  getConnection();
			System.out.println(conn);
			PreparedStatement preparedStatement = conn.prepareStatement( query );
			System.out.println("Running:"+query);
	...
	/*Describe the method for getting all the information regarding Humidity */
	@Override
	...
	/*Describe the method for Listing information of clima data based on Month */
	@Override
	...
	/*Describe the method for Listing information of clima data based on Year */
	@Override
	...
	/*Describe the method for Listing information of clima data based on all conditions */
	@Override
